...
public class Database : SingletonCustom<Database> {
    ...
    private PlayerCharStateData[] m_CaraStateArr = new PlayerCharStateData[CHAR_DATA_MAX] {
                ...
                new PlayerCharStateData(    1, 1.4f, 0.08f, 0.008f, 1.34f), //char02
                new PlayerCharStateData(    2, 0.9f, 0.15f, 0.010f, 1.29f), //char03
                new PlayerCharStateData(    3, 1.0f, 0.10f, 0.014f, 1.30f), //char04
            };
