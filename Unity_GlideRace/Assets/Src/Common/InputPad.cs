...
public static class InputPad {
    ...
    private const string APP = "Application";   //決定
    private const string CAN = "Cancel";        //取消
    ...
    public static Vector2 AllAxis() {
        return new Vector2(Input.GetAxis(HOR), Input.GetAxis(VER));
    }
    ...
    //決定・アクセル================================================================================
    public static bool AllAccel()     { return Input.GetButton(APP);     }
    public static bool AllAccelUp()   { return Input.GetButtonUp(APP);   }
    public static bool AllAccelDown() { return Input.GetButtonDown(APP); }
    ...
    //取消・ブレーキ===============================================================================
    public static bool AllBrake()       { return Input.GetButton(CAN); }
    public static bool AllBrakeUp()     { return Input.GetButtonUp(CAN); }
    public static bool AllBrakeDown()   { return Input.GetButtonDown(CAN); }
